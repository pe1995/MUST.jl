...
ext1 = "magg_m3_a4_c15_vmic2"

# ╔═╡ 6e6d4927-afd1-450c-ad02-a62802d143c3
ext2 = "magg_m3_a4_vmic2"
...
eos1 = reload(SqEoS, "/mnt/beegfs/gemini/groups/bergemann/users/eitner/storage/opacity_tables/$(ext1)_v1.1/combined_eos_$(ext1).hdf5")

# ╔═╡ c67235eb-69c2-49b6-afe7-5f9d8315e480
opa1 = reload(SqOpacity, "/mnt/beegfs/gemini/groups/bergemann/users/eitner/storage/opacity_tables/$(ext1)_v1.1/combined_opacities_$(ext1).hdf5", mmap=true)
...
# ╔═╡ 10d9e5e5-3ad0-41f1-b38c-a9bca9a00040
eos2.lnEi .- eos1.lnEi
...
κross1 = lookup(eos1, :lnRoss, isurf1.lnρ, isurf1.lnT)

# ╔═╡ add01598-f142-4035-9417-d52be0313a2e
κross2 = lookup(eos2, :lnRoss, isurf2.lnρ, isurf2.lnT)

# ╔═╡ d54e6e19-78ea-4dd9-bc37-1524d5ae406f
let
	plt.close()

	plt.plot(log10.(solar_model1.τ), exp.(solar_model1.lnT), label="neu")
	plt.plot(log10.(solar_model2.τ), exp.(solar_model2.lnT))
