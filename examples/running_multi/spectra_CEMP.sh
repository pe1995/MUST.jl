...
julia spectrum.jl -r "M1_E_t57.77g44.40m-4.000_v1.0_long" --extension="CEMP-CEMP" -n 357 -x 20 -s 4297 -e 4303 -d 0.001 --feh=-5.0 --alpha=0.4 --composition=C_3.0 --linelists="CHonly" --move -t 64 
...
julia spectrum.jl -r "M2_E_t57.77g44.40m-4.000_v1.0"      --extension="MP-CEMP"   -n 399 -x 20 -s 4297 -e 4303 -d 0.001 --feh=-5.0 --alpha=0.4 --composition=C_3.0 --linelists="CHonly" --move -t 64 