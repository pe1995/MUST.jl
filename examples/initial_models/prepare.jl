...
begin
    ...
    prepare4dispatch.resolution!(grid, patch_size=15, cut_bottom=0.35)
end

#====================== Step (C): Conversion =================================#
begin
    prepare4dispatch.fromT_to_E.(grid.info[!, "binned_tables"], grid.info[!, "binned_E_tables"], upsample=2048)
